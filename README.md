...
먼저 책상 위의 연구 노트를 읽으면 GI를 켜서 빨간 벽을 확인하라는 힌트를 얻는다.

![연구 노트](https://raw.githubusercontent.com/kohhyunkyung/gi-escape-room/main/escape%20room/%EB%B0%A91%20%EB%85%B8%ED%8A%B8%20%EC%9D%BD%EA%B8%B0.png)

*연구 노트에는 "GI를 활성화한 후 빨간 벽을 확인하라"는 힌트가 적혀 있다.*
...
*P키를 눌러 DDGI 프로브 격자를 시각화한 모습. 파란 점 하나하나가 조명 정보를 저장하는 프로브이며, 4×3×4 = 48개가 공간에 배치되어 있다. GI ON 상태에서 빨간 벽에 숫자 8, 2, 6이 형광으로 나타나는 것을 확인할 수 있다.*
