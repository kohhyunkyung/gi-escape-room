...
| 방 | 배경 | GI 활용 방식 | 목표 |
|---|---|---|---|
| 연구실 | Cornell Box 스타일 (빨강/초록/파랑 벽) | GI ON → 빨간 벽에 숫자 826 등장 | 금고 열고 열쇠 획득 |
| 지하실 | 정전으로 어두운 공간 | GI ON → 간접광으로 방 전체가 밝아짐 + 뒷벽에 5272 등장 | 퓨즈 교체 → 발전기 가동 → 배터리 획득 |
| 보안실 | SF 분위기 보안 구역 | GI ON → 4방향 벽/천장에 각각 다른 색 숫자 등장 | 숫자 조합(4321) → 패널 해제 → 탈출 |
